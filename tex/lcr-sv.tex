...
because LCR boundaries may not be exact and insertions are often placed right before exact tandem repeats by convention.
...
Longdust identifies most tandem repeats with $\ge$4 copies of repeat units as LCRs~\cite{Li:2020aa},
but it often misses tandem repeats with fewer copies and may report additional regions without clear tandem patterns.
83.5\% of our LCR regions overlap with tandem repeats found by TRF~\citep{Benson:1999aa} v4.10 (option {\tt 2 7 7 80 10 50 500 -l12})
and 92.0\% overlap with TR Catalog~\citep{English:2025aa} v1.2.1 which covers 238Mb of GRCh38, much larger than our regions.
...
to demonstraate the impact of LCR in SV calling.
...
Truvari was unable to process such variants and greatly overestimated the false positives.
...
On the ground truth, SVs in LCR contributed to 42.1\% of total SV lengths.
...
which performs multi-sequence alignment to normalize different variant representations.
...
This happens because minimap2 does not see other reads in the same region during pairwise alignment.
